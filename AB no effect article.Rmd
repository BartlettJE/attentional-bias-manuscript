...
The task consisted of 16 image pairs for neutral trials and 16 image pairs for smoking/non-smoking trials. We developed the matching smoking and non-smoking images in our lab (blinded citation) and we created neutral trials using 16 image pairs from the IAPS [@lang_international_2008]. The trial order was randomised with each picture pair presented four times to cover each combination of image (left and right) and dot location (left and right). For each picture pair, this process was repeated for each SOA condition. This procedure was repeated twice and presented in two blocks, creating 384 trials overall with 64 trials in each SOA and trial type condition.  
