...
We used 16 image pairs from the International Affective Picture System [@lang_international_2008] for the neutral trials. We developed a series of matching smoking and non-smoking images in our lab (blinded citation) for the smoking and non-smoking trials. The list of IAPS images we used is available on the OSF project and our smoking/non-smoking images are available on the Gorilla open materials page.  
...
For the confirmatory analyses, we focused on smoking/non-smoking stimuli pairs and excluded the neutral-neutral pairs. Originally, we planned on conducting exploratory analyses to create orienting and disengagement indices (reference) by subtracting the mean response time to neutral-neutral from smoking-nonsmoking trials (orienting) or nonsmoking-smoking trials (disengagement), but a coding error meant we did not having matching numbers of neutral-neutral trials in the 200ms and 500ms SOA conditions. Therefore, we focused on our confirmatory analyses and excluded neutral-neutral trials.
